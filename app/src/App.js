  ...
  return (
    <HashRouter history={history}>
      ...
      <Switch>
        ...
        <CheckoutTemplate path='/checkout/:maLichChieu' exact Component={CheckoutPage} />

        <AdminTemplate path='/admin/films' exact Component={FilmManagementPage} />
        <AdminTemplate path='/admin/films/create' exact Component={HomePage} />
        <AdminTemplate path='/admin/films/edit/:filmId' exact Component={HomePage} />
        <AdminTemplate path='/admin/films/showtime/:filmId.:tenphim' exact Component={ShowtimePage} />
        <AdminTemplate path='/admin/users' exact Component={UserManagementPage} />
