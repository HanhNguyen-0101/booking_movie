...
export default function Footer() {
  ...
  useEffect(() => {
    dispatch(getInformationOfTheaters());
      ...
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-4/5 sm:grid-cols-4">
          <div className="space-y-3">
            <div className="uppercase dark:text-gray-50 font-bold">
              {t("info")}
            </div>
          ...
          <div className="space-y-3">
            <div className="uppercase dark:text-gray-50 font-bold">Đối tác</div>
              ...
              {theaters?.map((theater, index) => {
                return (
                  <Fragment key={index}>
                    <NavLink to="/" className="hover:text-red-500">
                      <Avatar
                        className="my-2 mr-3 ml-0 p-1 bg-white"
                        src={theater.logo}
                        alt={theater.tenHeThongRap}
                      />
                    </NavLink>
                    {index !== 0 && (index + 1) % 3 === 0 ? <br /> : ""}
                  </Fragment>
                );
              })}
            </div>
