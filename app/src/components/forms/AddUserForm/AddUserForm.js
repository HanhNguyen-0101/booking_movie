...
import { layDanhSachLoaiNguoiDung, themNguoiDung } from "../../../redux/actions/UserManagementAction";
const { Option } = Select;

export default function AddUserForm() {
  const { t } = useTranslation();
  const dispatch = useDispatch();
  const { dsLoaiNguoiDung } = useSelector(
  ...
  return (
    ...
    >
      ...
      >
        <Select
          onChange={handleChangeFirst('maLoaiNguoiDung')}
